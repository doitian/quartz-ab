...
**[[bft-consensus-analysis/bft-consensus/protocols/hotstuff|HotStuff]]** uses provable broadcast to achieve **linear communication complexity** (O(n) instead of O(n²)) and **responsive liveness** (progress at network speed).
...
**[[bft-consensus-analysis/bft-consensus/protocols/honeybadger-bft|HoneyBadgerBFT]]** uses threshold cryptography for **asynchronous BFT** with guaranteed liveness even under network attacks.
...
- **[[bft-consensus-analysis/provable-broadcast/provable-broadcast|Provable Broadcast Mechanisms]]**: Protocol specifications
- **[[bft-consensus-analysis/bft-consensus/protocols/hotstuff|HotStuff]]**: Linear BFT using QCs
- **[[bft-consensus-analysis/bft-consensus/protocols/honeybadger-bft|HoneyBadgerBFT]]**: Asynchronous BFT with threshold signatures
- **[[bft-consensus-analysis/bft-consensus/protocols/protocol-comparison|Protocol Comparison]]**: Comparing BFT protocols
